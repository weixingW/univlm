#!/usr/bin/env python3
"""
Test script for Janus Pro roundtrip generation.
"""
...
def test_januspro_roundtrip():
    """Test Janus Pro roundtrip generation."""
    
    # Model path - you'll need to update this to your actual Janus Pro model path
    model_path = "deepseek-ai/Janus-Pro-7B"  # Update this path
    ...
    try:
        ...
        output_path = "test_januspro_generated_image.jpg"
        ...
        print("\n✓ Janus Pro roundtrip test completed successfully!")
        
    except Exception as e:
        print(f"Error during Janus Pro roundtrip test: {str(e)}")
        import traceback
        traceback.print_exc()


if __name__ == "__main__":
    test_januspro_roundtrip() 