#!/usr/bin/env python3
"""
Example usage of OmniGen2 roundtrip generation.

This script demonstrates how to use the OmniGen2 roundtrip generator
...
def example_omnigen2_roundtrip():
    """Example of using OmniGen2 for roundtrip generation."""
    ...
    try:
        ...
        print(f"\nRunning OmniGen2 roundtrip generation...")
        ...
        print(f"\n✓ OmniGen2 roundtrip generation completed!")
        ...
        print(f"Error during OmniGen2 roundtrip generation: {str(e)}")
        import traceback
        traceback.print_exc()


def example_single_prompt():
    """Example of processing a single prompt with OmniGen2."""
    ...
    try:
        ...
        # Save image
        image_path = "omnigen2_single_test_image.jpg"
        ...
        # Save caption
        caption_path = "omnigen2_single_test_caption.txt"
...
if __name__ == "__main__":
    print("OmniGen2 Roundtrip Generation Examples")
    print("=" * 50)
    
    # Uncomment the example you want to run:
    
    # Example 1: Full roundtrip generation with prompts file
    # example_omnigen2_roundtrip()
